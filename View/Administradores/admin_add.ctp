					...
					<div class="table-responsive">
						<table class="table">
												...
												<td><?= $this->Form->input('ultimo_acceso'); ?></td>
																				...
																				<tr>
												<th><?= $this->Form->label('google_id', 'Google'); ?></th>
												<td><?= $this->Form->input('google_id'); ?></td>
											</tr>
																				<tr>
												<th><?= $this->Form->label('google_dominio', 'Google dominio'); ?></th>
												<td><?= $this->Form->input('google_dominio'); ?></td>
											</tr>
																				<tr>
												<th><?= $this->Form->label('google_nombre', 'Google nombre'); ?></th>
												<td><?= $this->Form->input('google_nombre'); ?></td>
											</tr>
																				<tr>
												<th><?= $this->Form->label('google_apellido', 'Google apellido'); ?></th>
												<td><?= $this->Form->input('google_apellido'); ?></td>
											</tr>
																				<tr>
												<th><?= $this->Form->label('google_imagen', 'Google imagen'); ?></th>
												<td><?= $this->Form->input('google_imagen'); ?></td>
											</tr>
																				<tr>
