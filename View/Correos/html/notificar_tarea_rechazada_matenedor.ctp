              ...
              <TR style="HEIGHT: 20px">
                <TD style="BORDER-TOP: medium none; BORDER-RIGHT: medium none; WIDTH: 100%; VERTICAL-ALIGN: top; BORDER-BOTTOM: medium none; PADDING-BOTTOM: 0px; TEXT-ALIGN: left; PADDING-TOP: 35px; PADDING-LEFT: 15px; BORDER-LEFT: medium none; PADDING-RIGHT: 15px; BACKGROUND-COLOR: #feffff">
                  ...
                  <p style="FONT-SIZE: 14px; FONT-FAMILY: Arial, Helvetica, sans-serif; MARGIN-TOP: 0px; COLOR: #a8a7a7; LINE-HEIGHT: 155%; BACKGROUND-COLOR: transparent; mso-line-height-rule: exactly" align="left">
                    Su tarea #<?=$alerta['Tarea']['id']; ?> fue revisada por el administrador y lamentablemente fue <b>rechazada</b>.
                  </p>
                  <p style="FONT-SIZE: 14px; FONT-FAMILY: Arial, Helvetica, sans-serif; MARGIN-TOP: 0px; COLOR: #a8a7a7; LINE-HEIGHT: 155%; BACKGROUND-COLOR: transparent; mso-line-height-rule: exactly" align="left">
                    Revise los comentarios de la tarea y recuerde siempre completar todos los datos de los productos agregados a las tareas.
                  </p>
                  ...
                  <?=$this->html->link('Revisar la tarea', array(
                      'controller' => 'tareas', 
                      'action' => 'review', 
                      $alerta['Tarea']['id'],
                      'maintainers' => true,
                      'full_base' => true), 
                      array(
                      'style' => 'background-color:#771D97; font-size: 14px; font-family: arial, helvetica, sans-serif; color: #ffffff; padding: 5px 15px; text-decoration: none; margin-top: 10px; display: inline-block; text-align: center;'
                      )
                    );?>
                  <BR>
                  <BR>
