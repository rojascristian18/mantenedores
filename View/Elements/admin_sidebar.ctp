 <!-- START SIDEBAR -->
<div class="sidebar" data-id="<?=$this->Session->read('Auth.Administrador.id');?>" data-role="admin">  
    <div class="sidebar-wrapper scroll">
        ...
        <div class="sidebar-tab-content active" id="sidebarMensajes">
            ...
            <?= $this->Form->create('Comentario', array('url' => array('controller' => 'comentarios', 'action' => 'comentar', 'admin' => false), 'class' => 'form-horizontal form-comentarios collapse', 'type' => 'file', 'id' => 'FormularioComentarios' ,'inputDefaults' => array('label' => false, 'div' => false, 'class' => 'form-control'))); ?>
            
            <?  if ($this->request->params['prefix'] == 'admin') : ?>
                <?= $this->Form->input('usuario_id', array('type' => 'hidden'));?>
                <?= $this->Form->input('notificar_comentario_mantenedor', array('type' => 'hidden', 'value' => 1));?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body col-xs-12 col-sm-4">
                ...
                <?= $this->Form->create('Comentario', array('url' => array('controller' => 'comentarios', 'action' => 'comentar', 'admin' => false), 'class' => 'form-horizontal form-comentarios', 'type' => 'file', 'id' => 'FormularioComentariosModal' ,'inputDefaults' => array('label' => false, 'div' => false, 'class' => 'form-control'))); ?>
