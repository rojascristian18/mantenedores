		...
		<div class="col-xs-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Editar Grupocaracteristica</h3>
				</div>
					...
					<div class="table-responsive">
						<table class="table">
												...
												<td><?= $this->Form->input('desripcion'); ?></td>
																				...
																				<tr>
												<th><?= $this->Form->label('count_caracteristicas', 'Count caracteristicas'); ?></th>
												<td><?= $this->Form->input('count_caracteristicas'); ?></td>
											</tr>
																				<tr>
