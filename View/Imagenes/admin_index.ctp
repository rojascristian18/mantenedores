					...
					<div class="table-responsive">
						<table class="table">
							...
							<tbody>
								...
								<tr>
											<td><?= $this->Html->link($imagen['Producto']['nombre'], array('controller' => 'productos', 'action' => 'edit', $imagen['Producto']['id'])); ?></td>
													<td><?= h($imagen['Imagen']['nombre']); ?>&nbsp;</td>
													<td><?= h($imagen['Imagen']['imagen']); ?>&nbsp;</td>
													<td><?= ($imagen['Imagen']['activo'] ? '<i class="fa fa-check"></i>' : '<i class="fa fa-remove"></i>'); ?>&nbsp;</td>
													<td><?= h($imagen['Imagen']['created']); ?>&nbsp;</td>
											<td>
