...
<?= $this->Form->create('Notificacion', array('class' => 'form-horizontal', 'type' => 'file', 'inputDefaults' => array('label' => false, 'div' => false, 'class' => 'form-control'))); ?>
<div class="page-content-wrap">
	<div class="row">
		<div class="col-xs-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Editar Notificacion</h3>
				</div>
					...
					<div class="table-responsive">
						<table class="table">
												...
												<td><?= $this->Form->input('mensaje'); ?></td>
																				...
																				<tr>
												<th><?= $this->Form->label('visualizada', 'Visualizada'); ?></th>
												<td><?= $this->Form->input('visualizada', array('class' => 'icheckbox')); ?></td>
											</tr>
																				<tr>
