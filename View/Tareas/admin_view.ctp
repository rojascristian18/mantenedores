...
<div class="page-content-wrap">
	...
	<!-- Exportar -->
	<? if ( $this->request->data['Tarea']['finalizado'] ) : ?>
	<div class="row">
		<div class="col-xs-12">
			<div class="panel panel-success">
				...
				<div class="panel-body">
					<p>Seleccione la versión de Prestashop de su comercio para realizar la exportación de los productos de esta tarea.</p>
				</div>
				<div class="panel-body">
					<?= $this->Form->create('Tarea', array('action' => 'exportar_productos'), array('class' => 'form-horizontal tareas-form', 'type' => 'file', 'inputDefaults' => array('label' => false, 'div' => false, 'class' => 'form-control'))); ?>
					<?=	$this->Form->input('id');?>
					<div class="col-xs-12 col-sm-3">
						<?= $this->Form->label('version', 'Versión de Prestashop'); ?>
					</div>
					<div class="col-xs-12 col-sm-6">
						<?= $this->Form->select('version', array(
							'1.6.1.11' => 'Prestashop 1.6.1.11',
							'1.6.0.8' => 'Prestashop 1.6.0.8',
							), array('class' => 'form-control', 'empty' => 'Seleccione versión')); ?>
					</div>
					<div class="col-xs-12 col-sm-3">
						<?= $this->Form->submit('Exportar', array('class' => 'btn btn-primary btn-block', 'escape' => false, 'div' => false)); ?>
					</div>
					<?= $this->Form->end(); ?>
				</div>
			</div>
