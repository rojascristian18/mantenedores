							...
							<thead>
								<tr class="sort">
													<th><?= $this->Paginator->sort('nombre', null, array('title' => 'Haz click para ordenar por este criterio')); ?></th>
															...
															<th><?= $this->Paginator->sort('prefijo', null, array('title' => 'Haz click para ordenar por este criterio')); ?></th>
															<th><?= $this->Paginator->sort('principal', null, array('title' => 'Haz click para ordenar por este criterio')); ?></th>
													<th>Acciones</th>
								</tr>
							</thead>
							<tbody>
								...
								<tr>
													...
													<td><?= h($tienda['Tienda']['prefijo']); ?>&nbsp;</td>
													<td><?= ($tienda['Tienda']['principal'] ? '<i class="fa fa-check"></i>' : '<i class="fa fa-remove"></i>'); ?>&nbsp;</td>
											<td>
