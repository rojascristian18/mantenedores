$(function() {
	...
	var comentarios = function(){
        ...
        var obtenerTareas = function(){
        	...
        	if ($('#listadoTareasAjax').length) {
        		$.get( webroot + '/comentarios/obtenerTareasComentarios/' + limit + '/' + offset, function(respuesta){
        ...
        var obtenerComentariosPorTareaId = function($id){
        	$.get( webroot + '/comentarios/obtenerComentariosPorTareaId/' + $id, function(respuesta){
				$res = $.parseJSON(respuesta);
